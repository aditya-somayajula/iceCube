...
# ---------- ---------- ---------- Main Function ---------- ---------- ---------- #
def main():
    """Display Data Analytics Page elements"""
    with st.sidebar:
        st.caption("_Perform data analytics activities in the IceCube application_")
        st.button("Query", type="primary")
        st.button("ML", type="primary")
# ---------- ---------- ---------- ---------- ---------- ---------- ---------- #
...
if __name__ == "__main__":
    ...
    with col2:
        st.markdown("""<style>.centered-title {text-align: center;}</style><h1 class="centered-title">Data Analytics</h1>""", unsafe_allow_html=True)
    with col3:
