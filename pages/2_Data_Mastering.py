...
# ---------- ---------- ---------- Main Function ---------- ---------- ---------- #
def main():
    """Display Data Mastering Page elements"""
    with st.sidebar:
        st.caption("_Perform data mastering activities in the IceCube application_")
        st.button("Model", type="primary")
        st.button("Explore", type="primary")
        st.button("Master", type="primary")
# ---------- ---------- ---------- ---------- ---------- ---------- ---------- #
...
if __name__ == "__main__":
    ...
    if st.session_state["authenticated"]:
        st.session_state["page"] = "Data Mastering"
    else:
    ...
    with col2:
        st.markdown("""<style>.centered-title {text-align: center;}</style><h1 class="centered-title">Data Mastering</h1>""", unsafe_allow_html=True)
    with col3:
