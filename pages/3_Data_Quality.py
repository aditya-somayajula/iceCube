...
# ---------- ---------- ---------- Main Function ---------- ---------- ---------- #
def main():
    """Display Data Quality Page elements"""
    with st.sidebar:
        st.caption("_Perform data quality activities in the IceCube application_")
        st.button("Rules", type="primary")
...
if __name__ == "__main__":
    ...
    with col2:
        st.markdown("""<style>.centered-title {text-align: center;}</style><h1 class="centered-title">Data Quality</h1>""", unsafe_allow_html=True)
    with col3:
